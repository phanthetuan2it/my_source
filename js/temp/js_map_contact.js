...
<script type="text/javascript">
   ...
   var infowindow_array= new Array();
	function initialize(){
	   var defaultLatLng = new google.maps.LatLng(<?=$company['googlemaps']?>);
	   var myOptions= {
		   zoom: 11,
	   ...
	   var arrLatLng = new google.maps.LatLng(<?=$company['googlemaps']?>);
	   infoWindowArray[7895] = '<div class="map_description"><div class="map_title"><?=$company["ten_".$lang]?></div><div>Địa Chỉ : <?=$company["diachi_".$lang]?></div></div>';
