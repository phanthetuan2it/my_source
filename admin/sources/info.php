...
function save_info(){
	...
	$file_name_background=images_name($_FILES['background']['name']);
	...
	if(count($row_item )>0){
		...
		if($background = upload_image("background", 'jpg|png|gif|JPG|jpeg|JPEG', _upload_hinhanh,$file_name_background)){
