...
<div class="control_frm" style="margin-top:0;">
    <div style="float:left;">
      <input type="button" class="btn btn-primary" value="Thêm" onclick="location.href='index.php?com=lkweb&act=add&type=<?=$_GET['type']?>'" />
        <input type="button" class="btn btn-primary" value="Hiện" onclick="ChangeAction('index.php?com=lkweb&act=man&multi=show&type=<?=$_GET['type']?>');return false;" />
        <input type="button" class="btn btn-primary" value="Ẩn" onclick="ChangeAction('index.php?com=lkweb&act=man&multi=hide&type=<?=$_GET['type']?>');return false;" />
