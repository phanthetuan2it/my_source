...
<?php if($config_background=='true'){ ?>
	<div class="formRow">
		<label>Tải background:</label>
		<div class="formRight">
        	<input type="file" id="file" name="background" />
			<img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title="Tải hình ảnh (ảnh JPEG, GIF , JPG , PNG)">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_hinhanh.$item['background']?>"  alt="NO PHOTO" style="max-width:100%;" /></div>
			</div>
			<div class="clear"></div>
		</div>
<?php } ?>
...
<?php if($config_mota=='true'){ ?>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea rows="4" id="mota_<?=$key?>" cols="" title="Nhập mô tả . " class="tipS" name="data[mota_<?=$key?>]"><?=@$item['mota_'.$key]?></textarea>
			</div>
			<div class="clear"></div>
		</div>
