...
<?php }?>
    ...
    <div class="formRow">
      <label>Tọa độ</label>
      <div class="formRight">
                <input type="text" name="data[toado]" title="Tọa độ googlemaps" id="toado" class="tipS validate[required]" value="<?=@$item['toado']?>" />
      </div>
      <div class="clear"></div>
    </div>
...
<div class="widget">
	<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=chinhanh&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-default tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
</div>
