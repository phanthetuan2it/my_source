...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	<input type="button" class="btn btn-primary" value="Thêm" onclick="location.href='index.php?com=thanhvien&act=add'" />
        <!-- <input type="button" class="btn btn-primary" value="Hiện" onclick="ChangeAction('index.php?com=thanhvien&act=man&multi=show');return false;" /> -->
        <!-- <input type="button" class="btn btn-primary" value="Ẩn" onclick="ChangeAction('index.php?com=thanhvien&act=man&multi=hide');return false;" /> -->
        <input type="button" class="btn btn-primary" value="Xoá" onclick="ChangeAction('index.php?com=thanhvien&act=man&multi=del');return false;" />
    </div>  
