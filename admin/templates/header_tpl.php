<?php
      ...
      $d->reset();
      $sql = "SELECT COUNT(*) as num FROM #_contact where view=0 and type='dangky'";
      $d->query($sql);
      ...
      $tong_count = $row_lienhe['num']+$row_dangky['num'] ; //+ $row_giohang['num'];
?>
<div class="wrapper">
        <div class="welcome"><a href="#" title=""><img src="images/userPic.png" alt="" /></a><span>Xin chào, <?=$_SESSION['login']['username']?>!</span></div>
        <div class="userNav">
            <ul>
                <!-- <li><a href="http://<?=$config_url?>" title="" target="_blank">Menu</a></li> -->
                ...
                <li><a href="../sitemap.php" title="" target="_blank"><img src="images/icons/topnav/subInbox.png" alt="" /><span>Cập nhật sitemap</span></a></li>
            </ul>
        </div>
        <div class="clear"></div>
    </div>