...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<object width="300" height="200"><param name="movie" value="//www.youtube.com/v/<?=id_youtube($item['links'])?>?version=3&amp;hl=vi_VN&amp;rel=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="//www.youtube.com/v/<?=id_youtube($item['links'])?>?version=3&amp;hl=vi_VN&amp;rel=0" type="application/x-shockwave-flash" width="300" height="200" allowscriptaccess="always" allowfullscreen="true" wmode="transparent" ></embed></object>
	...
	<!--	<div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.php?com=video&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="btn btn-default tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
