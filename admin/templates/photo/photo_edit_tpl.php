...
<?php foreach ($config['lang'] as $key => $value) { ?>
    ...
    <div class="title"><img src="./images/icons/dark/record.png" alt="" class="titleIcon" />
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                <div class="fileinput fileinput-new" data-provides="fileinput">
                    <span class="btn btn-default btn-file"><span>Choose file</span><input type="file" name="file_<?=$key?>" /></span>
        ...
        <div class="formRow">
            ...
            <div class="formRight">
                  <div class="mt10"><img src="<?=_upload_hinhanh.$item['thumb_'.$key]?>"  alt="NO PHOTO" width="100" /></div>
            </div>
            <div class="clear"></div>
