...
<link rel="stylesheet" href="../css/bootstrap/jasny-bootstrap.css">
<link href="css/main.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="js/external.js"></script>
<script src="js/jquery.price_format.2.0.js" type="text/javascript"></script>
<script src="../js/bootstrap/bootstrap.min.js" type="text/javascript"></script>
<script src="../js/bootstrap/jasny-bootstrap.js" type="text/javascript"></script>
...
<body>
	<?php $arr_exit=array('man_color','add_color','save_color','delete_color','edit_color'); ?>
	<?php if(in_array($_GET['act'], $arr_exit)) { include _template.$template."_tpl.php"; exit(); } ?>
<!-- Left side content -->    
<script type="text/javascript">
$(function(){
